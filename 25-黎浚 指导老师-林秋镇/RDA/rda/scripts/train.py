...
from RDA.rda.model.deeplabv2 import get_deeplab_v2
from RDA.rda.dataset.gta5 import GTA5DataSet
from RDA.rda.dataset.cityscapes import CityscapesDataSet

from RDA.rda.domain_adaptation.config import cfg, cfg_from_file
from RDA.rda.domain_adaptation.train_UDA import train_domain_adaptation
...
def get_arguments():
    ...
    parser.add_argument('--cfg', type=str, default="configs/RDA.yml",
