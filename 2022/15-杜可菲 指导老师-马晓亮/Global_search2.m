function [Exactly,condition,citr,slst,X, f, v, Pbestx, Pbestf,b,state] = Global_search2(Data,bu,bd,condition,slst,n,termination,citr,X, f, v, Pbestx, Pbestf, Gbestx, Gbestf)
c = size(Data,2)-1;
% kernal='cubic';
% kernal='linear';
kernal='gaussian';
