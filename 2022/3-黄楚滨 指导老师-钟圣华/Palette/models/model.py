...
'''
    EMA类：
    beta：超参数序列
    update_model_average：更新模型的均值
        zip:在这些元组组成的列表中不断迭代更新参数
    update_average:从前向推后向，new为标准高斯
'''
class EMA():
...
class Palette(BaseModel):
    def __init__(self, networks, losses, sample_num, task, optimizers, ema_scheduler=None, **kwargs):
        ...
        ''' networks can be a list, and must convert by self.set_device function if usingmultiple GPU. '''
