...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--src', default='./targetimg',type=str, help='Ground truth images directory')
    parser.add_argument('-d', '--dst', default='./output',type=str, help='Generate images directory')
