...
class ImageNetDataset(Dataset):
    ...
    def __init__(self, root, cfg, is_train):
        ...
        if self.is_train:
            datalist = os.path.join('/home/yzhang/TS-CAM-master/data/ImageNet_ILSVRC2012/', 'ILSVRC2012_list', 'train.txt')
            self.image_dir = os.path.join(self.root, 'train')
        else:
            datalist = os.path.join('/home/yzhang/TS-CAM-master/data/ImageNet_ILSVRC2012/', 'ILSVRC2012_list', 'val_folder_new.txt')
