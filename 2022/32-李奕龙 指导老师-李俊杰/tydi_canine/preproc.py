...
from tydi_canine import tydi_tokenization_interface, data
...
def convert_examples_to_features(
    ...
    for tydi_example in tydi_examples:
        ...
        for id,feature in enumerate(features):
            ...
            with open(os.path.join(store_path,f"{feature.unique_id}.pickle"), "wb") as fp:
    ...
    for doc_span_index, doc_span in enumerate(doc_spans):
        ...
        if is_training:
            ...
            if ((not contains_an_annotation) or
                ...
                answer_text = data.byte_slice(tydi_example.plaintext, answer_start_byte_offset,
                                              answer_end_byte_offset)
