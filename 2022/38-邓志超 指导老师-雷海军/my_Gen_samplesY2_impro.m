...
Ctrain = [posCtrain;negCtrain]; % 训练的 scoresA 得分 包括正样本和负样本
Dtrain = [posDtrain;negDtrain]; % 训练的 scoresB 得分 包括正样本和负样本
...
Ctest = [posCtest;negCtest];    % 测试的 scoresA 得分
Dtest = [posDtest;negDtest];    % 测试的 scoresB 得分
