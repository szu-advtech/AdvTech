...
from RDA.rda.utils import project_root, project_root_ADVENT
from RDA.rda.utils.serialization import yaml_load
...
# cfg.DATA_LIST_SOURCE = str(project_root_ADVENT / 'rda/dataset/gta5_list/{}.txt')
# cfg.DATA_LIST_TARGET = str(project_root_ADVENT / 'rda/dataset/cityscapes_list/{}.txt')
cfg.DATA_LIST_SOURCE = str(project_root / 'rda/dataset/gta5_list/{}.txt')
cfg.DATA_LIST_TARGET = str(project_root / 'rda/dataset/cityscapes_list/{}.txt')
# Directories
cfg.DATA_DIRECTORY_SOURCE = str('/data/rda/GTA5')
cfg.DATA_DIRECTORY_TARGET = str('/data/rda/CityScapes')
...
cfg.TRAIN.INFO_TARGET = str(project_root / 'rda/dataset/cityscapes_list/info.json')
...
cfg.TRAIN.LEARNING_RATE_faa = 1e-6
cfg.TRAIN.LAMBDA_FAA_AUX = 0.0002
...
cfg.TEST.INFO_TARGET = str(project_root / 'rda/dataset/cityscapes_list/info.json')
