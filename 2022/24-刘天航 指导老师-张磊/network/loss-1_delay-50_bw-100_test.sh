...
/sbin/tc class add dev ens33 parent 1a64: classid 1a64:104 htb rate 100000.0Kbit ceil 100000.0Kbit burst 12500.0KB cburst 12500.0KB
/sbin/tc qdisc add dev ens33 parent 1a64:104 handle 2054: netem loss 1.000000% delay 25.0ms
