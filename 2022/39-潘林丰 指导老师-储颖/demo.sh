#python main.py --model EDSR --scale 2 --save jnd_plos_sca2 --reset --patch_size 96 --loss 1*VGG54 




# EDSR baseline model (x2) + JPEG augmentation
python main.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset --save_results
