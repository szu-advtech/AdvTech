file_dir = './data/ORL4646.mat';
data_mat0 = load(file_dir).ORL4646;
...
writecell(par_list,'ORL_results.xls','Sheet',1,'Range','A1:G1');
...
for repeat_i = 1:repeatN  
    ...
    %}
    data_mat = func_digahole(data_mat0, 0);
...
writecell(result_list,'ORL_results.xls','Sheet',1,'Range','A2:G2');
...
writecell(result_list,'ORL_results.xls','Sheet',1,'Range','A3:G3');
...
writecell(result_list,'ORL_results.xls','Sheet',1,'Range','A4:G4');
...
writecell(result_list,'ORL_results.xls','Sheet',1,'Range','A5:G5');
