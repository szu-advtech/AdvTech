...
data_mat0 = load(file_dir).AR120p20s50by40;
...
writecell(par_list,'AR_results.xls','Sheet',1,'Range','A1:G1');
...
writecell(result_list,'AR_results.xls','Sheet',1,'Range','A2:G2');
...
writecell(result_list,'AR_results.xls','Sheet',1,'Range','A3:G3');
...
writecell(result_list,'AR_results.xls','Sheet',1,'Range','A4:G4');
...
writecell(result_list,'AR_results.xls','Sheet',1,'Range','A5:G5');
