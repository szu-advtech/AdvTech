...
def model_opts(parser):
    ...
    parser.add_argument('-ntm_type', type=str, default='ntm', help='set ntm type')
    
    parser.add_argument('-klw_cycle', type=int, default=4, help='kl_weight cycle')
    
    parser.add_argument('-klw_start', type=float, default=0.0, help='kl_weight start')
    
    parser.add_argument('-klw_stop', type=float, default=1.0, help='kl_weight stop')
    
    parser.add_argument('-klw_ratio', type=float, default=0.5, help='kl_weight ratio')
