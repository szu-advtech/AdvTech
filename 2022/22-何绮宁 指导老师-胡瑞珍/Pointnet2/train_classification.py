...
from data_utils.ftModelNetDataLoader import ftModelNetDataLoader
...
def main(args):
    ...
    data_path = 'data/modelnet40_new_test/'

    train_dataset = ftModelNetDataLoader(root=data_path, split='train')
    test_dataset = ftModelNetDataLoader(root=data_path, split='test')
