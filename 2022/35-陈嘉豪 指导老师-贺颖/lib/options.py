...
def args_parser():
    ...
    parser.add_argument('--ways', type=int, default=3, help="num of classes on each device")
    parser.add_argument('--shots', type=int, default=100, help="number of training instances per class")
    parser.add_argument('--train_shots_max', type=int, default=100, help="num of shots")
