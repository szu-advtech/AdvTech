...
def create_argparser():
    ...
    parser.add_argument("--data_dir",  default="/datasets/fastmri/knee_singlecoil_val",type=str)
    parser.add_argument("--data_info_dir", default="/data/fastmri1", type=str)
    parser.add_argument("--num_files", default=-1, type=int)
    parser.add_argument("--num_pd_files", default=-1, type=int)
    parser.add_argument("--num_pdfs_files", default=0, type=int)
    parser.add_argument("--data_info_file_name", default='pd_test_info',type=str)
    return parser
