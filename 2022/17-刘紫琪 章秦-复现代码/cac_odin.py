...
if __name__ == "__main__":
    ...
    if opt.dataset == 'CIFAR10':
        ...
        test_known_dataset = torchvision.datasets.ImageFolder('data/tiny-imagenet-200/train',
                                                       transform=transforms.Compose([
        ...
        save_path = "save_models/20221204/SVHN_cac.pth"
    ...
    for loader in [test_known_loader, test_unknown_loader, train_unknown_loader]:
        for step, (inputs, labels) in enumerate(loader):
            ...
            # nnOutputs = nnOutputs * (1 - nnOutputs)
