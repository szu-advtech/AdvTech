...
# 实际上相当于把 train 装进 calc_patch_size
@calc_patch_size
def train(args):
    ...
    for image_path in sorted(glob.glob('{}/*'.format(args.images_dir))):
        ...
        for hr in hr_images:
            ...
            # args.scale == 2 -> args.patch_size = 10  lr:(10, 10) hr:(20, 20)
            # args.scale == 3 -> args.patch_size = 7   lr:(7, 7) hr:(14, 14)
            # args.scale == 4 -> args.patch_size = 6   lr:(6, 6) hr:(12, 12)
