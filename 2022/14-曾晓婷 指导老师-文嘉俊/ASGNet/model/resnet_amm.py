...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, dilation=1, use_amm=True):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, strides=(2, 2, 2, 2), dilations=(1, 1, 1, 1), use_amm=True, num_classes=1000, deep_base=True):
        self.inplanes = 64
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1, use_amm=True):
        downsample = None
