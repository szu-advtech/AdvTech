...
# Code for "HRank: Filter Pruning using High-Rank Feature Map"
# Lin, Mingbao and Ji, Rongrong and Wang, Yan and Zhang, Yichen and Zhang, Baochang and Tian, Yonghong and Shao, Ling
