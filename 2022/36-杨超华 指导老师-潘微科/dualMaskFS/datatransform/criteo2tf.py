...
parser.add_argument("--dataset", type=Path, default='../../datasets/original/criteo/train.txt')
parser.add_argument("--stats", type=Path, default='../data/criteo/stats')
parser.add_argument("--record", type=Path, default='../data/criteo/threshold_2')
