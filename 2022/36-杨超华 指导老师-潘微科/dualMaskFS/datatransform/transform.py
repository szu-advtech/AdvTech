...
class DataTransform(object):
    ...
    def _read(self, name=None, header=None, sep=None, label_index=""):
        ...
        self.train_data = pd.read_table(self.data_path1, names=name, header=header, sep=sep)
        self.test_data = pd.read_table(self.data_path2, names=name, header=header, sep=sep)
        self.data = pd.concat([self.train_data, self.test_data], ignore_index=True)
