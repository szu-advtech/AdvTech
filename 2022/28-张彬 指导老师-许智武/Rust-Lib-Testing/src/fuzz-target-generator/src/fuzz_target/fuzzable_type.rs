...
use rustdoc::clean::{self, PrimitiveType};

use crate::fuzz_target::call_type::CallType;
use crate::fuzz_target::impl_util::FullNameMap;
use crate::fuzz_target::prelude_type::PreludeType;
use crate::fuzz_target::api_parameter::ApiParameter;
    ...
    pub fn generate_fuzzable_type_and_call_type(&self) -> (FuzzableType, CallType) {
        ...
        match self {
            ...
            FuzzableCallType::Primitive(primitive) => (
                FuzzableType::Primitive(primitive.clone()),
            ...
            FuzzableCallType::BorrowedRef(type_) => {
                ...
                return (
                    fuzzable_type,
                    CallType::_BorrowedRef(Box::new(inner_call_type)),
                );
            }
            FuzzableCallType::MutBorrowedRef(type_) => {
                ...
                return (
                    fuzzable_type,
                    CallType::_MutBorrowedRef(Box::new(inner_call_type)),
                );
            }
            FuzzableCallType::String => {
                return (FuzzableType::String, CallType::_ToString);
            }
            FuzzableCallType::RefStr => {
            ...
            FuzzableCallType::ToOption(inner_fuzzable_call_type) => {
                ...
                return (
                    fuzzable_type,
                    CallType::_ToOption(Box::new(inner_call_type)),
                );
            }
            FuzzableCallType::Array(_) | FuzzableCallType::Slice(_) => {
                return (FuzzableType::NoFuzzable, CallType::_NotCompatible);
            }
            FuzzableCallType::Generic => {
                return (FuzzableType::NoFuzzable, CallType::_NotCompatible);
            }
        }
    }

    pub fn replace_generic_call_by(&self, replace_fuzzable_call_type: &FuzzableCallType) -> FuzzableCallType{
        match self {
            FuzzableCallType::Generic => {
                return replace_fuzzable_call_type.clone();
            },
            FuzzableCallType::MutRawPoiner(fuzz_call_type, clean_ty) => {
                let new_fuzz_call_type = &**fuzz_call_type;
                return FuzzableCallType::MutRawPoiner(Box::new(new_fuzz_call_type.replace_generic_call_by(replace_fuzzable_call_type)), clean_ty.clone());
            }
            FuzzableCallType::ConstRawPoiner(fuzz_call_type, clean_ty) => {
                let new_fuzz_call_type = &**fuzz_call_type;
                return FuzzableCallType::ConstRawPoiner(Box::new(new_fuzz_call_type.replace_generic_call_by(replace_fuzzable_call_type)), clean_ty.clone());
            }
            FuzzableCallType::Tuple(fuzz_call_types) => {
                let mut new_fuzz_call_types = Vec::new();
                for fuzz_call_type in fuzz_call_types{
                    let new_fuzz_call_type = &**fuzz_call_type;
                    new_fuzz_call_types.push(Box::new(new_fuzz_call_type.replace_generic_call_by(replace_fuzzable_call_type)));
                }
                return FuzzableCallType::Tuple(new_fuzz_call_types);
            }
            FuzzableCallType::Slice(fuzz_call_type) => {
                let new_fuzz_call_type = &**fuzz_call_type;
                return FuzzableCallType::Slice(Box::new(new_fuzz_call_type.replace_generic_call_by(replace_fuzzable_call_type)));
            }
            FuzzableCallType::Array(fuzz_call_type) => {
                let new_fuzz_call_type = &**fuzz_call_type;
                return FuzzableCallType::Array(Box::new(new_fuzz_call_type.replace_generic_call_by(replace_fuzzable_call_type)));
            }
            FuzzableCallType::BorrowedRef(fuzz_call_type) => {
                let new_fuzz_call_type = &**fuzz_call_type;
                return FuzzableCallType::BorrowedRef(Box::new(new_fuzz_call_type.replace_generic_call_by(replace_fuzzable_call_type)));
            }
            FuzzableCallType::MutBorrowedRef(fuzz_call_type) => {
                let new_fuzz_call_type = &**fuzz_call_type;
                return FuzzableCallType::MutBorrowedRef(Box::new(new_fuzz_call_type.replace_generic_call_by(replace_fuzzable_call_type)));
            }
            FuzzableCallType::ToOption(fuzz_call_type) => {
                let new_fuzz_call_type = &**fuzz_call_type;
                return FuzzableCallType::ToOption(Box::new(new_fuzz_call_type.replace_generic_call_by(replace_fuzzable_call_type)));
            }
            _ => {
                return self.clone();
            }
...
impl FuzzableType {
    ...
    pub fn _to_type_string(&self) -> String {
        match self {
            ...
            FuzzableType::Primitive(primitive) => primitive.as_sym().as_str().to_string(),
            ...
            FuzzableType::String => "String".to_string(),
            ...
            FuzzableType::Use => {"USE".to_string()}
        }
    }

    pub fn get_traits(&self) -> Vec<String> {
        match &self {
            FuzzableType::String => vec![String::from("core::fmt::Display"), String::from("core::fmt::Debug")],
            _ => Vec::new(),
        }
    }

    pub fn as_string_name(&self) -> String {
        match self {
            FuzzableType::NoFuzzable => "nofuzzable".to_string(),
            FuzzableType::Primitive(primitive) => primitive.as_sym().as_str().to_string(),
            FuzzableType::RefSlice(inner_) => {
            ...
            FuzzableType::RefStr => "&str".to_string(),
            FuzzableType::String => "alloc::string::String".to_string(),
            FuzzableType::Tuple(inner_types) => {
                let mut res = "(".to_string();
                let first_type = inner_types.first();
                if let Some(first) = first_type {
...
// TODO: 目前只支持Primitive和String
pub fn fuzzable_call_type_by_api_parameter(api_param: &ApiParameter, origin_fuzzable_call_type: FuzzableCallType) -> FuzzableCallType {
    match api_param {
        ApiParameter::Struct(api_struct)
        | ApiParameter::Enum(api_struct) => {
            origin_fuzzable_call_type.replace_generic_call_by(&FuzzableCallType::NoFuzzable)
        },
        ApiParameter::Preluded(preluded_struct) => {
            match &preluded_struct.preluded_type{ 
                FuzzableType::NoFuzzable
                | FuzzableType::Use
                | FuzzableType::RefSlice(_)
                | FuzzableType::RefStr
                | FuzzableType::Tuple(_) => origin_fuzzable_call_type.replace_generic_call_by(&FuzzableCallType::NoFuzzable),
                FuzzableType::Primitive(primitive_type) => origin_fuzzable_call_type.replace_generic_call_by(&FuzzableCallType::Primitive(primitive_type.clone())),
                FuzzableType::String => origin_fuzzable_call_type.replace_generic_call_by(&FuzzableCallType::String),
            }
        }
    }
}
...
pub fn fuzzable_call_type_by_clean_type(ty_: &clean::Type, full_name_map: &FullNameMap) -> FuzzableCallType {
    match ty_ {
        clean::Type::Path { .. } => {
            ...
            match &prelude_type {
                ...
                PreludeType::PreludeOption(inner_type_) => {
                    let inner_fuzzable_call_type = fuzzable_call_type_by_clean_type(inner_type_, full_name_map);
        ...
        clean::Type::Tuple(types) => {
            ...
            for inner_type in types {
                let inner_fuzzable = fuzzable_call_type_by_clean_type(inner_type, full_name_map);
        ...
        clean::Type::Slice(inner_type) => {
            ...
            let inner_fuzzable = fuzzable_call_type_by_clean_type(inner_ty_, full_name_map);
            match inner_fuzzable {
                FuzzableCallType::NoFuzzable => {
                    return FuzzableCallType::NoFuzzable;
                }
        ...
        clean::Type::BorrowedRef {
                ...
                && *mutability == Mutability::Not
            {
                ...
                return FuzzableCallType::RefStr;
            }
            let inner_fuzzable = fuzzable_call_type_by_clean_type(inner_type, full_name_map);
            match inner_fuzzable {
                FuzzableCallType::NoFuzzable => {
