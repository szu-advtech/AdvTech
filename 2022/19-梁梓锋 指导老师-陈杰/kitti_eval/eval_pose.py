...
parser.add_argument("--max-depth", default=50)
...
def main():
    ...
    for j, sample in enumerate(tqdm(framework)):
        ...
        poses = poses.cpu()[0] # 取第1个位姿，也就是最前时刻的位姿
...
def compute_pose_error(gt, pred):
    ...
    with open("/home/aston/Projects/python/SfmLearner-Pytorch/output/pose/09_pred.txt", "ab") as f:
        temp = pred
        np.savetxt(f, temp[1].reshape(1, 12), fmt='%1.06e')
    with open("/home/aston/Projects/python/SfmLearner-Pytorch/output/pose/09_temp.txt", "ab") as f:
        np.savetxt(f, gt[1].reshape(1, 12), fmt='%1.06e')
