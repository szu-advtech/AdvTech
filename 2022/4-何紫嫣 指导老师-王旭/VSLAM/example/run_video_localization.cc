...
int main(int argc, char* argv[]) {
    ...
    if (!vocab_file_path->is_set() || !tsdf_file_path->is_set() || !video_file_path->is_set()
    ...
    if (cfg->camera_->setup_type_ == openvslam::camera::setup_type_t::Monocular) {
        mono_localization(cfg, vocab_file_path->value(), tsdf_file_path->value(), video_file_path->value(), mask_img_path->value(),
