...
import os
import datetime
from .GetRemainder import SortReturn, readPKL, olmarBalance
...
class OLMAR_BAH(Algo):
    ...
    def __init__(self, datasetname, window=5, eps=10, percentage=None):
        ...
        super(OLMAR_BAH, self).__init__(min_history=window)
    ...
    def step(self, x, last_b, history):
        ...
        dataTool = SortReturn(x, history, self.percentage, history.shape[1], index=1)
