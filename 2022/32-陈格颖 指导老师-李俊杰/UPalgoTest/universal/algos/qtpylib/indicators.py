...
if __name__ == "__main__":
    file_name ="/home/aze/Documents/szufintech-portfolio-risk-master/portfolio-risk/UPalgoTest/universal/data/djia.pkl"
    data_set = pd.read_pickle(file_name)
    result = macd(data_set["A"], 3, 2, 16)
    print(result[1:16])
