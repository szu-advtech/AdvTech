...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="output_model/medical_model/bert-base-chinese_cls/", type=str)
    ...
    parser.add_argument("--index_file", default="indices/medical/ct_corpus.pt", type=str)
    parser.add_argument("--topk", type=int, default=1000)
    parser.add_argument("--input_file", default="../data/medical/dev.query.txt", type=str)
    parser.add_argument("--output_file", default="output/medical/bert-base-chinese_cls.dev.l2.out", type=str)
