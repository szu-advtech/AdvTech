...
class Encoder(object):
    def __init__(self, pretrained_model_path, pool_type='max', max_seq_length=40):
        ...
        self.device = torch.device("cpu") if not  torch.cuda.is_available else torch.device("cuda:6")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="output_model/mixed_model/bert-base-chinese_cls/", type=str, help="sbert or prop")
