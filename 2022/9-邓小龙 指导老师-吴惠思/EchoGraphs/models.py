...
from nets.CNN_PRM_GCN import CNNPRMGCN
import os
...
def load_model(cfg:CfgNode, is_gpu: bool = True, kpts_extractor_weights: str = None) -> torch.nn.Module:
    ...
    elif model_name == 'CNNPRMGCN':
        model = CNNPRMGCN(kpt_channels=2, gcn_channels=[4, 8, 8, 16, 16, 32, 32, 48], backbone=backbone, num_kpts=num_kpts, is_gpu=is_gpu)
        model.output_type = 'img2kpts'
