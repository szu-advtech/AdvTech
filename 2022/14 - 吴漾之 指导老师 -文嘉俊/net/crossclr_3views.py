...
class CrosSCLR(nn.Module):
    ...
    def __init__(self, base_encoder=None, pretrain=True, feature_dim=128, queue_size=32768,
                 ...
                 graph_args={'layout': 'ntu-rgb+d', 'strategy': 'spatial'},  # dict类
        ...
        super().__init__()  # nn.Module子类的函数必须在构造函数中执行父类的构造函数
        base_encoder = import_class(base_encoder)  # net.st_gcn.Model
