...
from src.simulator.network_simulator import network, packet
from src.simulator.network_simulator.constants import BITS_PER_BYTE, BYTES_PER_PACKET, EVENT_TYPE_SEND
