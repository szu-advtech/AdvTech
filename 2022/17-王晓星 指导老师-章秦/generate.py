...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_path', default='log/raw_cpm_ft.log', type=str, required=False, help='日志存放位置')
    parser.add_argument('--no_cuda', action='store_true', help='不使用GPU进行预测')
    parser.add_argument('--model_path', type=str, default='model/raw/epoch4', help='模型存放位置')
    ...
    title_list = []
    context_list = []
    f=open('evaluation/raw_title.txt','r',encoding='utf-8')
