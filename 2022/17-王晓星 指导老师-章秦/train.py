...
def set_args():
    ...
    parser.add_argument('--vocab_path', default='vocab/chinese_vocab.model', type=str, required=False,
                        help='sp模型路径')
    parser.add_argument('--model_config', default='model/CPM-large/config.json', type=str, required=False,
                        help='需要从头训练一个模型时，模型参数的配置文件')
    parser.add_argument('--train_path', default='data/train_raw/train.pkl', type=str, required=False, help='经过预处理之后的数据存放路径')
    ...
    parser.add_argument('--save_model_path', default='model/raw', type=str, required=False,
                        help='模型输出路径')
    parser.add_argument('--pretrained_model', default='model/CPM-large', type=str, required=False,
                        help='预训练的模型的路径')
