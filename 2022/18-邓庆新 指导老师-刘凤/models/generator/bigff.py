...
class BiGFF(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.structure_gate = nn.Sequential(
            nn.Conv2d(in_channels=in_channels + in_channels, out_channels=out_channels, kernel_size=3, stride=1, padding=1),#channel-wise
            nn.Sigmoid()
        )
    ...
    def forward(self, texture_feature, structure_feature):
        ...
        return torch.cat((texture_feature, structure_feature), dim=1)#channel-wise