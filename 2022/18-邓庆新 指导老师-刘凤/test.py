...
with torch.no_grad():
    ...
    for _ in tqdm(range(opts.number_eval)):
        ...
        #print(output_comp.size())
    
        save_image(torch.cat([ground_truth,input_image,output_comp],3), opts.result_root + '/{:05d}.png'.format(_))
        #save_image(output_comp, opts.result_root + '/mouth3.png')
