...
class data_VIGOR(torch.utils.data.Dataset):
    def __init__(self, mode = '', root = '/data/zhangqingwang/dataset/VIGOR/', same_area=True, print_bool=False, polar = '', args=None):
        super(data_VIGOR, self).__init__()
