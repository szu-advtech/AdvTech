...
import numpy as np
from dataset.data_VIGOR import data_VIGOR
from model.vigor import VIGOR
from criterion.soft_triplet import SoftTripletBiLoss
from dataset.global_sampler import DistributedMiningSamplerVigor
