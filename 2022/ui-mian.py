...
class MyWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.moudle_btn = self.ui.comboBox # 忘记密码按钮
        self.moudle_btn.setStyleSheet(
            "QComboBox{font:63 11pt 微软雅黑;border:0px; border-radius:3px; color:#FFFFFF; background-color:#2278C6}"
            "QComboBox:hover{font:63 11pt 微软雅黑;border:0px; border-radius:3px;background-color:#1891FF;}"
        )
     ...
     # Training
    def train(self,epoch, opt, net, writer, trainloader, optimizer, KLloss, MSEloss, Polar_coordinates, MSELoss_theta, Polarloss):
        print('\nEpoch: %d' % epoch)
        global train_acc
        train_loss = 0
        train_loss1 = 0
        ...
        for batch_idx, data in enumerate(trainloader):
            ...
            "QTextBrower{font:63 12pt 微软雅黑;border:0px; border-radius:3px; color:#FFFFFF; background-color:#2278C6}"
    ...
    # Test
    def test(self,epoch, net, writer, testloader, KLloss, best_test_acc, best_test_acc_epoch, path, MSEloss, Polar_coordinates, MSELoss_theta, Polarloss):
        global test_acc
    ...
    def run(self):
        ...
        parser.add_argument('--gpu', default=7, type=int, help='0|1|2|3')
    ...
    # set gpu device
        ...
        for epoch in range(start_epoch, total_epoch):
            print(epoch)
            self.train(epoch, opt, net, writer, trainloader, optimizer, KLloss, MSEloss, Polar_coordinates, MSELoss_theta, Polarloss)
            best_test_acc, best_test_acc_epoch = self.test(epoch, net, writer, testloader, KLloss, best_test_acc,
