...
def homo_warping(src_fea, src_proj, ref_proj, depth_values):    #将src图的特征体，根据ref和src的投影矩阵，投影到ref视角下
    # src_fea: [B, C, H, W]
    # src_proj: [B, 4, 4]
    # ref_proj: [B, 4, 4]
...
def depth_regression(p, depth_values):   #深度回归，根据之前假设的192个深度经过网络算完得到的不同概率，乘以深度假设，求得期望
