...
Config.Train.num_workers = 4 ###4》0
...
Config.Train.iter_num = 100000####循环次数
...
Config.Model.backbone =  'hourglass'##'resnet50' ####修改网络
Config.Model.num_stacks = 2
Config.Model.nms_type_for_stage1 = 'nms'  # or 'soft_nms' or'nms'
...
Config.Distributed.dist_url = 'tcp://127.0.1.1:34564'##tcp://127.0.0.1:34564 tcp://172.31.226.16:22
